...
namespace Catalog.Application.Handlers
{
    public class GetProductByBrandHandler : IRequestHandler<GetProductByBrandQuery, IList<ProductResponse>>
    {
        ...
        {
            var productList = await _productRepository.GetProductByName(request.BrandName);
            var productRepositoryList = ProductMapper.MapperExt.Map<IList<ProductResponse>>(productList);
